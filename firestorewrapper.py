...
class FirebaseAPI:
    ...
    def get_information(self,DiscordUser):# this should return a dictionary of {subject1: [chapter1,chapter2,chaptern]}
    ...
    def create_user(self,DiscordUser): # if not user.exists()
